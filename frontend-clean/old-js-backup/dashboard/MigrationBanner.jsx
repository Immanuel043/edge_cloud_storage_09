...
/**
 * Banner component that prompts users to migrate V1 encrypted files to V2
 */
export default function MigrationBanner() {
  ...
  // Check if ZK session is locked - can't migrate without unlocked session
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-green-700 mt-1">
              ...
              {migrationResult.skipped > 0 && ` ${migrationResult.skipped} file(s) already up to date.`}
            </p>
          </div>
          <button
          ...
          {showDetails && (
            <div className="mt-3 p-3 bg-white/50 rounded-lg text-sm text-gray-600">
              ...
              <p className="mt-2 text-xs text-gray-500">
                Files will be re-downloaded, re-encrypted, and re-uploaded. This may take a while for large files.
              </p>
            </div>
          )}
