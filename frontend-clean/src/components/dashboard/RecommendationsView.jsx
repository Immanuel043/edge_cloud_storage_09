...
export default function RecommendationsView({ darkMode, onFileClick }) {
  ...
  const [activeTab, setActiveTab] = useState('forYou'); // 'forYou', 'trending', 'similar'
  ...
  const handleFeedback = async (recId, isHelpful) => {
    try {
    ...
    <div className="space-y-6">
      ...
      {activeTab === 'forYou' && (
        <div className="flex items-center gap-2">
          ...
          {['hybrid', 'content', 'collaborative', 'trending'].map((algo) => {
