...
async function initModules() {
  ...
  argon2Module = argon2.default || argon2;
}

/**
 * Derive key using Argon2id with memory fallback
 */
async function deriveKeyArgon2id(password, salt, options = {}) {
  await initModules();
 ...
 */
function deriveKeyHKDF(masterKey, label) {
 ...
 */
function encryptChunk(chunkData, fileKey, fileId, chunkIndex) {
 ...
 */
function decryptChunk(encryptedChunk, fileKey, fileId, chunkIndex) {
