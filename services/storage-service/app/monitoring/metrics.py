...
url_upload_active = Gauge(
    'storage_url_upload_active',
    'Number of currently active URL uploads'
)
...
folder_upload_active = Gauge(
    'storage_folder_upload_active',
    'Number of currently active folder upload sessions'
)
...
quota_prediction_worker_errors_total = Counter(
    'storage_quota_prediction_worker_errors_total',
    'Total number of quota prediction worker errors'
)

quota_usage_history_recorded_total = Counter(
    'storage_quota_usage_history_recorded_total',
    'Total number of usage history records created'
)

quota_predictions_generated_total = Counter(
    'storage_quota_predictions_generated_total',
    'Total number of quota predictions generated'
)

quota_alerts_generated_total = Counter(
    'storage_quota_alerts_generated_total',
    'Total number of quota alerts generated'
)

quota_alerts_dismissed_total = Counter(
    'storage_quota_alerts_dismissed_total',
    'Total number of quota alerts dismissed'
)

quota_prediction_cache_hits_total = Counter(
    'storage_quota_prediction_cache_hits_total',
    'Total number of quota prediction cache hits'
)

quota_prediction_cache_misses_total = Counter(
    'storage_quota_prediction_cache_misses_total',
    'Total number of quota prediction cache misses'
)
...
storage_optimization_worker_errors_total = Counter(
    'storage_optimization_worker_errors_total',
    'Total number of storage optimization worker errors'
)

storage_analyses_completed_total = Counter(
    'storage_analyses_completed_total',
    'Total number of storage analyses completed'
)

storage_analysis_cache_hits_total = Counter(
    'storage_analysis_cache_hits_total',
    'Total number of storage analysis cache hits'
)

storage_analysis_cache_misses_total = Counter(
    'storage_analysis_cache_misses_total',
    'Total number of storage analysis cache misses'
)
...
storage_potential_savings_bytes = Gauge(
    'storage_potential_savings_bytes',
    'Potential storage savings in bytes',
    ['user_id']
)
...
organization_sessions_started_total = Counter(
    'organization_sessions_started_total',
    'Total number of organization sessions started'
)

organization_sessions_completed_total = Counter(
    'organization_sessions_completed_total',
    'Total number of organization sessions completed'
)

organization_sessions_failed_total = Counter(
    'organization_sessions_failed_total',
    'Total number of organization sessions failed'
)

organization_clusters_created_total = Counter(
    'organization_clusters_created_total',
    'Total number of organization clusters created'
)

organization_clusters_applied_total = Counter(
    'organization_clusters_applied_total',
    'Total number of organization clusters applied'
)

organization_clusters_dismissed_total = Counter(
    'organization_clusters_dismissed_total',
    'Total number of organization clusters dismissed'
)

organization_files_moved_total = Counter(
    'organization_files_moved_total',
    'Total number of files moved by organization'
)

organization_rules_created_total = Counter(
    'organization_rules_created_total',
    'Total number of organization rules created'
)

organization_rules_applied_total = Counter(
    'organization_rules_applied_total',
    'Total number of organization rules applied'
)

organization_rules_updated_total = Counter(
    'organization_rules_updated_total',
    'Total number of organization rules updated'
)

organization_rules_deleted_total = Counter(
    'organization_rules_deleted_total',
    'Total number of organization rules deleted'
)
...
recommendations_dismissed_total = Counter(
    ...
    'Total number of recommendations dismissed'
)
...
recommendation_feedback_errors_total = Counter(
    ...
    'Total number of recommendation feedback errors'
)
...
user_interaction_tracking_errors_total = Counter(
    ...
    'Total number of user interaction tracking errors'
)

content_similarity_computations_total = Counter(
    'content_similarity_computations_total',
    'Total number of content similarity computations'
)
...
content_similarity_cache_hits_total = Counter(
    'content_similarity_cache_hits_total',
    'Total number of content similarity cache hits'
)

content_similarity_cache_misses_total = Counter(
    'content_similarity_cache_misses_total',
    'Total number of content similarity cache misses'
)

content_similarity_errors_total = Counter(
    'content_similarity_errors_total',
    'Total number of content similarity errors'
)

content_similarity_batch_errors_total = Counter(
    'content_similarity_batch_errors_total',
    'Total number of batch content similarity errors'
)
...
collaborative_filtering_errors_total = Counter(
    ...
    'Total number of collaborative filtering errors'
)

trending_files_computed_total = Counter(
    'trending_files_computed_total',
    'Total number of trending files computations'
)

trending_computation_errors_total = Counter(
    'trending_computation_errors_total',
    'Total number of trending computation errors'
)
...
batch_recommendation_jobs_failed_total = Counter(
    'batch_recommendation_jobs_failed_total',
    'Total number of batch recommendation jobs failed'
)
