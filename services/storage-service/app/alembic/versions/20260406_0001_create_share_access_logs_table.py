...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('share_link_id', UUID(as_uuid=True), sa.ForeignKey('share_links.id', ondelete='SET NULL'), nullable=True),
        sa.Column('bundle_id', UUID(as_uuid=True), sa.ForeignKey('share_bundles.id', ondelete='SET NULL'), nullable=True),
