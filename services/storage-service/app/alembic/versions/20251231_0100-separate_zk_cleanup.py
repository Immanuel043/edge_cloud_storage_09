...
def upgrade():
    ...
    op.add_column(
        "users", sa.Column("billing_status", sa.String(20), nullable=True, server_default="active")
    )
...
def downgrade():
    ...
    op.add_column(
        "objects", sa.Column("is_encrypted", sa.Boolean(), nullable=True, server_default="false")
    )
    ...
    op.add_column(
        "users", sa.Column("zk_storage_quota", sa.BigInteger(), nullable=True, server_default="0")
    )
    op.add_column(
        "users", sa.Column("zk_storage_used", sa.BigInteger(), nullable=True, server_default="0")
    )
    op.add_column(
        "users", sa.Column("zk_enabled", sa.Boolean(), nullable=True, server_default="false")
    )
