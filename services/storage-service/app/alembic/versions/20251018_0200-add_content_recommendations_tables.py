...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "similarity_type", sa.String(50), nullable=False
    ...
    op.create_table(
        ...
        sa.Column(
            "interaction_weight", sa.Float, nullable=False
        ),  # Weighted score (view=1, download=2, share=3, favorite=5)
    ...
    op.create_table(
        ...
        ),  # File that triggered recommendation
        # Recommendation details
        sa.Column(
            "recommendation_type", sa.String(50), nullable=False
        ),  # similar, collaborative, trending, personalized
        sa.Column("recommendation_score", sa.Float, nullable=False),  # 0-1
        sa.Column(
            "algorithm", sa.String(50), nullable=False
        ),  # tfidf, collaborative_user, collaborative_item, hybrid
