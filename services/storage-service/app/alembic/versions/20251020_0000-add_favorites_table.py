...
Revises: content_recommendations_001
...
down_revision = 'content_recommendations_001'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_index('idx_objects_user_last_accessed', 'objects', ['user_id', 'last_accessed'], if_not_exists=True)
