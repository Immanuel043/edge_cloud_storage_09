...
def upgrade() -> None:
    ...
    op.create_index("idx_file_name_suggestions_file_id", "file_name_suggestions", ["file_id"])


def downgrade() -> None:
    op.drop_index("idx_file_name_suggestions_file_id", table_name="file_name_suggestions")
