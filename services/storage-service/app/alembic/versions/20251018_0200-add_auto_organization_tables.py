...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('cluster_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('organization_clusters.id', ondelete='CASCADE'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('rule_type', sa.String(50), nullable=False),  # pattern, extension, date, ml_cluster
    ...
    op.create_table(
        ...
        # Session details
        sa.Column('session_type', sa.String(50), nullable=False),  # ml_clustering, rule_based, manual
