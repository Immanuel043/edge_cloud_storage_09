...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "source_text_hash", sa.String(64), nullable=True
        ),  # SHA256 hash to detect changes
        sa.Column(
            "source_type", sa.String(50), default="filename"
    ...
    op.create_unique_constraint(
        "unique_file_embedding_source", "file_embeddings", ["file_id", "source_type"]
    )
