...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "rotation_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("key_rotation_history.id")
        ),
    ...
    op.create_index("idx_reencrypt_priority", "data_reencryption_queue", ["priority", "queued_at"])
