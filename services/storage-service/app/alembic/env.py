# services/storage-service/app/alembic/env.py
import asyncio
import os
...
from app.models.database import Base, User, Folder, Object, ActivityLog, FileVersion
...
def get_url():
    ...
    This matches what your docker-compose.yml provides
    """
    # Your docker-compose sets DATABASE_URL
