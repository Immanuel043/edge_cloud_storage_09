...
router = APIRouter(prefix="/api/v1/subscription-ui", tags=["subscription-ui"])
...
async def compare_plans(
    ...
    Args:
        plan_codes: Comma-separated list of plan codes (e.g., "normal_free,normal_basic,normal_pro")
