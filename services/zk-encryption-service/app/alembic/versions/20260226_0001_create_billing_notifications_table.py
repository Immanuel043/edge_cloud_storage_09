...
and notification history. Without it, zk-billing-scheduler fails on startup.
...
def upgrade():
    ...
    # Indexes
    op.create_index('idx_notifications_user', 'billing_notifications',
                    ['user_id', 'service_type'])
    op.create_index('idx_notifications_subscription', 'billing_notifications',
                    ['subscription_id'])
    op.create_index('idx_notifications_status', 'billing_notifications',
                    ['status'])
    op.create_index('idx_notifications_due_date', 'billing_notifications',
                    ['payment_due_date'])
    op.create_index('idx_notifications_type', 'billing_notifications',
                    ['notification_type'])
